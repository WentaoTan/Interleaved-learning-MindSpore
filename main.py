...
# from mindspore.backends import cudnn
...
def get_mix_train_loader(args, dataset, height, width, batch_size, workers,
    ...
    rmgs_flag = False
    train_loader = GeneratorDataset(Preprocessor(train_set, root=dataset.images_dir, transform=train_transformer),
                   sampler=sampler,shuffle=rmgs_flag,column_names=["data0","data1","data2","data3","data4"],)
    train_loader = train_loader.batch(batch_size, drop_remainder=True)
    train_loader = IterLoader(train_loader,length=None)
    return train_loader
...
def get_test_loader(dataset, height, width, batch_size, workers, testset=None):
    ...
    test_loader = GeneratorDataset(
        ...
        shuffle=False,column_names=["data0","data1","data2","data3","data4"])
